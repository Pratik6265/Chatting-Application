...
public class Server extends JFrame implements ActionListener, KeyListener{
        ...
        p1.setBackground(new Color(2,94,84));
        p1.setBounds(0,0,450,70);
        p1.setLayout(null);
        f.add(p1);
        ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("icons/3.png"));
        Image i2=i1.getImage().getScaledInstance(35, 25, Image.SCALE_DEFAULT);
        ...
        Image i5=i4.getImage().getScaledInstance(35, 25, Image.SCALE_DEFAULT);
        ...
        p1.add(more);
        JLabel  name =new JLabel("gaitonde1");
